...
I have the code up at https://github.com/JosiahKerley/python-filegen and it can be installed with `pip install https://github.com/JosiahKerley/python-filegen/archive/master.zip`.